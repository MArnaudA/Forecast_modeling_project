...
public class PageInscriptionVendeurController {
	@FXML
	...
	public PageInscriptionVendeurController() {
	...
	private void handleOk() {
		if (isInputValid()) {
			...
			user.setNomEntreprise(nomEntrepriseTextField.getText());
			okClicked = true;
	...
	private boolean isInputValid() {
		...
		if(nomEntrepriseTextField.getText()==null || nomEntrepriseTextField.getText().length()==0) {
			errorMessage+="Le nom de l'entreprise est vide";
		}
